...
<head>
	...
	<link rel="stylesheet" type="text/css" href="estilo/equipe.min.css">
...
<div class="cotainer-fluid" style="padding-bottom: 18px;">
	<div class="container">
		<div class="row" style="margin-top: 5px;">
			<div class="col-lg-8 col-md-8 col-12">
	  			<div class="cont_box_staff">
	  				<h3> <i style="color: #f50cff;" class="fas fa-globe-asia"></i> Gerente(s)</h3>
	  			</div>
				<div class="layout_staff">
					<div class="img_staff_avatar" style="background: url('http://habbo.city/habbo-imaging/avatarimage?figure=lg-3136-76.sh-3252-92-92.hr-832-56.cc-3246-76.ch-660-92.hd-605-10.he-1610-62&size=b&action=wav&direction=3&head_direction=3&gesture=sml');"></div>
						<h6>NomeUser</h6>
						<div  class="function_ranks"><p>Função:</p> </div>
					
				</div>

					<div class="cont_box_staff" style="margin-top: 13px;">
	  				<h3> <i style="color: #f50cff; " class="fas fa-globe-asia"></i> Administrador(es)</h3>
	  			</div>
					...
					<div class="cont_box_staff" style="margin-top: 13px;">
	  				<h3> <i style="color: #f50cff;"  style="margin-top: 13px;"class="fas fa-globe-asia"></i> Moderador(es)</h3>
	  			</div>
			...
			<div class="col-lg-4 col-md-4 col-12" style="margin-top: 13px;">
				<div class="cont_box_staff">
	  				<h3> <i style="color: #f50cff;" class="fas fa-globe-asia"></i> Ceo(s)</h3>
	  			</div>
	  				  			  						<div class="layout_staff">
					<div class="img_staff_avatar" style="background: url('http://habbo.city/habbo-imaging/avatarimage?figure=lg-3136-76.sh-3252-92-92.hr-832-56.cc-3246-76.ch-660-92.hd-605-10.he-1610-62&size=b&action=wav&direction=3&head_direction=3&gesture=sml');"></div>
						<h6>NomeUser</h6>
			...
			<div class="card">
			  <div class="card-header" style="background-color: #12306d; color: #fff;">
			   <i class="fas fa-star-half-alt"></i>  Equipe Habbop
			  </div>
			  <div class="card-body" style="background-color: #1a4090; color: #fff;">
			    <blockquote class="blockquote mb-0">
			      <p style="font-size: 11pt;">Os funcionários de habbop hotel tem  uma missão importante carregada nas suas costas que é, de manter o hotel em equilibrio, manter estável com os usuários sendo interagidos em eventos dentre outros, cada um possui uma determinada função, que ou seja esta função é uma missão dada para eles cumprirem.</p>
			    </blockquote>
			  </div>
			</div>
			...
			<div class="card">
			  <div class="card-header" style="background-color: #12306d; color: #fff;">
			   <i class="far fa-question-circle"></i>  Eu preciso de ajuda!
			  </div>
			  <div class="card-body" style="background-color: #1a4090; color: #fff;">
			    <blockquote class="blockquote mb-0">
			    	<img src="img/franks.gif" class="img-fluid" style="margin-left: 25%;">
			      <p style="font-size: 11pt; text-indent: 1.5em;">Para tirar dúvidas ou estiver com algum problema, apenas digite por <b>ajuda (texto)</b> que um dos funcionários de habbop hotel vai está  analisando seu caso para tirar sua dúvia ou até mesmo te ajudar.</p>
			    </blockquote>
			  </div>
			</div>
			</div>
