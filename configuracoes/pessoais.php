...
<head>
	<meta charset="utf-8">
	<title> - Configurar conta pessoal</title>
			...
			<div class="container-fluid">
					...
					<div class="col-md-4 col-12 col-lg-4 back_menu">
						<div class="menu_config" data-animar="left">
							...
							<ul class="main_menu_config">
								...
								<li><a   href="<?php echo $pessoais; ?>"><i class="far fa-hand-pointer"></i> Interações</a></li>
								<li><a style="color: #f50cff;" href="<?php echo $pessoais; ?>" id="conf2"><i class="far fa-user"></i> Pessoais</a></li>
				...
				<div class="col-md-6 col-12 col-lg-6 back_configurar">
					<div id="avatar_c">
						...
						<p>Altere seus dados para caso precise, se quer migrar para outro e-mail e lembrando que você deverá informar um e-mail válido para casos emergênciais, pois não possuímos sistema de  validação de e-mail.</p>
						<br>
						<br>
						<br>
						<br>
					<form method="post">
					  <div class="form-group">
					    <label for="exampleInputEmail1" style="color: #fff;">Alterar o E-mail</label>
					    <input type="email" name="email_c" class="form-control" id="exampleInputEmail1" name="e_mail_c"aria-describedby="emailHelp" placeholder="seu e-mail">
					    <small id="emailHelp" class="form-text text-muted">Informe um e-mail válido para casos de perda da conta.</small>
					  </div>
					  <div class="form-group">
					    <label for="exampleInputPassword1" style="color: #fff;">Alterar a senha</label>
					    <input type="password"  name="pass_c"class="form-control" id="exampleInputPassword1" placeholder="Sua senha">
					    <small id="emailHelp" class="form-text text-muted">Informe uma senha que consiga lembrar.</small>
					  </div>
					  <button type="submit" name="save_personal" class="btn btn-primary">Salvar alterações</button>
					</form>
				</div>
