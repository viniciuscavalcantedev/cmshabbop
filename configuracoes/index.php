...
<head>
	<meta charset="utf-8">
	<title> - Página não encontrada x.x!</title>
	...
	<div class="container"  style="margin-bottom: 50px;">
		<div class="row">
			<div class="col-12 col-lg-12 col-md-12">
				<img  data-animar="left" class="img-fluid" style="margin-left: 25%; margin-top: 150px;" src="../img/logo_habbops.png">
			</div>
		</div>
		<div class="row" style="margin-top: 10px;">
			<div class="col-lg-12 col-12 col-md-12" style="background-color: #89108d; border-radius: 8px; padding: 10px;">
				<div class="message_error">
					<img data-animar="left"  src="../img/frank_error.gif" class="img-fluid" style="margin-left: 43%;">
					<h1 data-animar="left"  style="color: #fff;">Error - Página não encontrada!</h1>
					<p  data-animar="left"  data-animar="left"  style="color: #fff;">Desculpe, mas o frank não conseguiu achar está pagina ou você não possui o acesso. :/</p>

					<a  data-animar="left"  href=""><button class="btn btn-primary">VOLTAR</button></a>
				</div>
			</div>
		</div>
	</div>
