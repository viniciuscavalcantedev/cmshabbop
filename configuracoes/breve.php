					...
					<div class="col-md-4 col-12 col-lg-4 back_menu">
						<div class="menu_config" data-animar="left">
							...
							<ul class="main_menu_config">
								<li><a style="color: #f50cff;" href="avatar.html" ><i class="fas fa-address-book"></i> Avatar</a></li>
								<li><a  href="interacoes.html"><i class="far fa-hand-pointer"></i> Interações</a></li>
								<li><a href="pessoais.html" id="conf2"><i class="far fa-user"></i> Pessoais</a></li>
								<li><a href="perfil.html" id="conf3"><i class="fas fa-address-book"></i>  Perfil</a></li>
							...
							<div class="cont_box_two">
	  						...
	  						<ul class="main_menu_config">
								<li><a href="breve.html" ><i class="fas fa-address-book"></i> Perfil</a></li>
								<li><a href="breve.html" ><i class="far fa-comment"></i> Apelido</a></li>
								<li><a href="breve.html" ><i class="far fa-user"></i> Personalização</a></li>
							</ul>
	  						...
	  						<div class="cont_box_two">
	  						  ...
	  						  <ul class="main_menu_config">
								<li><a href="breve.html" ><i class="fab fa-facebook"></i> Facebook</a></li>
								<li><a href="breve.html" ><i class="fab fa-twitter-square"></i> Twitter</a></li>
								<li><a href="breve.html" ><i class="fab fa-google"></i> Google</a></li>
							</ul>
							...
							<div class="cont_box_two">
	  						  ...
	  						  <ul class="main_menu_config">
								<li><a href="breve.html" id="conf10"><i title="Configurações" class="fas fa-cogs"></i> Ensinar</a></li>
								<li><a href="breve.html" id="conf11"><i title="Configurações" class="fas fa-cogs"></i> Sugestões</a></li>
								<li><a href="breve.html" id="conf12"> <i title="Configurações" class="fas fa-cogs"></i> Adicionar</a></li>
							</ul>
